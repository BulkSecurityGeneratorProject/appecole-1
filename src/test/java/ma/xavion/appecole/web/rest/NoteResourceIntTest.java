...
public class NoteResourceIntTest {
    ...
    private static final LocalDate DEFAULT_DATE_CONTROLE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE_CONTROLE = LocalDate.now(ZoneId.systemDefault());
     ...
     *
     * @see ma.xavion.appecole.repository.search.NoteSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createNote() throws Exception {
        ...
        assertThat(testNote.getDateControle()).isEqualTo(DEFAULT_DATE_CONTROLE);
    ...
    public void updateNote() throws Exception {
        ...
        assertThat(testNote.getDateControle()).isEqualTo(UPDATED_DATE_CONTROLE);
    ...
    public void searchNote() throws Exception {
        // Initialize the database
        noteService.save(note);
        when(mockNoteSearchRepository.search(queryStringQuery("id:" + note.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(note), PageRequest.of(0, 1), 1));
        // Search the note
